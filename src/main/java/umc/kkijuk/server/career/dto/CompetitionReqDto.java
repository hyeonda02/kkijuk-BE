...
public class CompetitionReqDto {
    ...
    @Size(max = 20)
    @Schema(description = "대회명", example = "웹 개발 해커톤", type="string")
    private String name;

    @NotBlank(message = "활동 별칭은 필수 입력 항목입니다. 최대 20자 까지 입력 가능")
    @Size(max = 20)
    @Schema(description = "활동 별칭", example = "IT 연합 동아리 해커톤", type="string")
...
//    private String summary;
    ...
    @Schema(description = "팀/개인 여부", example = "true", type = "boolean")
